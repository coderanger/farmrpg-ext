...
export const setupPets = state => {
    ...
    state.addPageFilter("https://farmrpg.com/petinfo.php?*", visitPetInfo)
    state.addPageFilter("https://farmrpg.com/pet.php?*", visitPet)
    state.addPageFilter("https://farmrpg.com/pets.php", visitPets)
    state.addPageFilter("https://farmrpg.com/allpetitems.php?*", visitAllPetItems)
    // Collect one
