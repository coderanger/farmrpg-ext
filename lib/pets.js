...
export const setupPets = state => {
    ...
    setupPageFilter("https://farmrpg.com/petinfo.php?*", async (page, url) => {
        await visitPetInfo(state, page, url)
    })
    setupPageFilter("https://farmrpg.com/pet.php?*", async (page, url) => {
        await visitPet(state, page, url)
    })
    setupPageFilter("https://farmrpg.com/pets.php", async (page, url) => {
        await visitPets(state, page, url)
    })
    setupPageFilter("https://farmrpg.com/allpetitems.php?*", async (page, url) => {
        state.lastView = "pets"
        await renderSidebar(state)
    })
    // Collect one
