...
export const setupAnimals = state => {
    state.addPageFilter("https://farmrpg.com/namechicken.php?*", visitNameAnimal)
    state.addPageFilter("https://farmrpg.com/namecow.php?*", visitNameAnimal)
    state.addPageFilter("https://farmrpg.com/namepig.php?*", visitNameAnimal)
    state.addPageFilter("https://farmrpg.com/nameraptor.php?*", visitNameAnimal)
}
